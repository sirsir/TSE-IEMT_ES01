...
#Region "Method"
    ...
    Private Sub Reply4ToPlc()
        m_clsLog.LogByLine(Me.m_clsPlcCommunication.StageCode, clsLogger.MessageType.NormalLog, Me.GetType.Name, "Reply4ToPlc", "Start Function", "")
        ...
        ConcatByte(bytSendData, OMRON.FinsGateway.PLCDataConverter.SystemIntegerToPLC2ByteAsBCD(Me.m_intStatusCodePrefix + PLC_WRITE_STATUS_ERROR))
        ...
        Me.m_intStatusCodePrefix = 0
        Me.m_intSkitNo = 0
        m_clsLog.LogByLine(Me.m_clsPlcCommunication.StageCode, clsLogger.MessageType.NormalLog, Me.GetType.Name, "Reply4ToPlc", "End Function", "")
    End Sub
