...
#Region "Attribute"
    Private m_nProcessType As dsPAINT.dtPROCESS_MSTDataTable.enuProcessType = _
    dsPAINT.dtPROCESS_MSTDataTable.enuProcessType.Paint
#End Region
...
#Region "Method"
    ...
    Public Overrides Sub LoadData(ByVal strProductionDate As String, _
        ...
        s_taCol.FillByPassResult(ds.dtPROCESS_MST, ProcessType, m_nProcessType, True)
            ...
            For Each colKey As String In htCols.Keys
                ...
                For Each drCell As dsPAINT.dtPAINT_CELLRow In drCells
                    ...
                    If strKey = strCellKey Then
                        ...
                        strVals(intColIdx) = drCell.RESULT_DATE
                    End If
                Next drCell
            Next colKey
