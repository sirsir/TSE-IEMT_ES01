Public Class frmDATE_PartNo_Show


    Public Property pp_dpsTRACE_COLUMNS_ID As Integer
    Public Property pp_dpsDateFrom As Date
    Public Property pp_dpsDateTo As Date

    Private m_taSerialNoView As DataSet1TableAdapters.SERIAL_NO_PART_NO_SHOWTableAdapter


    Private Sub frmDATE_PartNo_Show_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        InitializeControls()
        ...
        m_dtEngineList = m_taSerialNoView.GetDataByLINE_ON_TIME_AND_TRACE_ID(pp_dpsDateFrom, pp_dpsDateTo, pp_dpsTRACE_COLUMNS_ID)
