    ...
    Private Sub frmProductionManualInputWorkingData_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            If modGlobalVariables.searchBy = modGlobalVariables.SEARCH_BY.ENGINE_NO Then
                ...
                m_dtWorkingFloat = m_taWorkingFloat.GetDataByWorkingTypeId_EngineNo_REV(modGlobalVariables.workingtypeID, modGlobalVariables.arrIn(0), modGlobalVariables.arrIn(1))
            ...
            ElseIf m_dtWorkingFloat.Rows.Count > 0 Then
                datInputDate = m_dtWorkingFloat(0).REVISE_DATE
