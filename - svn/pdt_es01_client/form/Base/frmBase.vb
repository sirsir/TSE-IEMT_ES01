Public Class frmBase
    ...
    Protected Overridable Sub ButtonMAINMENU_Click(sender As Object, e As EventArgs) Handles ButtonMAINMENU.Click
        'drawseparator()
        Try
        ...
        For Each ctrl As Control In Me.Panel1.Controls
            ...
            If hCtrl.ContainsKey(ctrl.Name) Then
                ...
                If TypeOf ctrl Is Button Then
                    ...
                    If ctrl.Name = "ButtonManualInput" Then
    ...
    Protected Overridable Sub ButtonPRINT_Click(sender As Object, e As EventArgs) Handles ButtonPRINT.Click
        ...
        Try
            ...
            If SaveFileDialog1.ShowDialog = Windows.Forms.DialogResult.OK Then
                ...
                If Me.Name = "frmWorkingData" Then
                    strTemplateFilename = String.Format("{0}-{1}.xlsx", _
                                                        Me.GetType.Name, modGlobalVariables.workingtypeName)
                Else
                    strTemplateFilename = Me.Name & ".xlsx"

                End If

                objExcel.WriteDataToExcel(ctrlTemp _
                                          , strTemplateFilename _
    ...
    Protected Overridable Sub ButtonManualInput_Click(sender As Object, e As EventArgs) Handles ButtonManualInput.Click
    ...
    Private Sub ButtonUPDATE_Click(sender As Object, e As EventArgs) Handles ButtonUPDATE.Click
        Try
            ...
            If modValidate.ValidationParamSet.CONFIRM_SAVE.MyMessageBox() <> DialogResult.Yes Then
                Return
            End If
            ...
            m_tam.WORKING_DATA_FLOATTableAdapter = New DataSet1TableAdapters.WORKING_DATA_FLOATTableAdapter
            ...
            If CtrlPivotGrid1.Rows.Count <> 1 Then
                Exit Sub
            End If
            ...
            Dim strListInvalidCells As String = ""
            ...
            For i As Integer = 0 To CtrlPivotGrid1.ColumnCount - 1
                ...
                If CtrlPivotGrid1.Columns(i).Visible Then
                    If CtrlPivotGrid1.Columns(i).Name Like "ID*" _
                        ...
                        'strRegExp = m_ds.V_SETTING_COLUMNS.FindByID(intEngineId).COLUMN_REGEX
                        'strRegExp = m_ds.V_SETTING_COLUMNS.FindByID(CtrlPivotGrid1.Item("WORKING_TYPE_ID", 0).Value).COLUMN_REGEX
                        strRegExp = m_ds.V_SETTING_COLUMNS.FindByID(intColumnId).COLUMN_REGEX



                        If Not IsDBNull(CtrlPivotGrid1.Item(i, 0).Value()) _
                            AndAlso Not modValidate.CheckRegExp(CtrlPivotGrid1.Item(i, 0).Value(), strRegExp) Then
                            'strColumnName = m_ds.V_SETTING_COLUMNS.FindByID(CtrlPivotGrid1.Item("WORKING_TYPE_ID", 0).Value).COLUMN_NAME
                            strColumnName = m_ds.V_SETTING_COLUMNS.FindByID(intColumnId).COLUMN_NAME
                            strColumnName = strColumnName.Substring(strColumnName.LastIndexOf("|") + 1)
                            strListInvalidCells &= String.Format("""{0}"" need to be format as ""{1}""" & Environment.NewLine, _
                                                                 strColumnName, strRegExp)
                        End If
                    End If
            ...
            If strListInvalidCells <> "" Then

                strListInvalidCells = "The following columns contains invalid format:" & Environment.NewLine & strListInvalidCells
                MessageBox.Show(strListInvalidCells, "Can not UPDATE!")
            ...
            If intRevNo = CtrlPivotGrid1.Item("REV_NO", 0).Value Then
                ...
                m_tam.WORKING_DATA_FLOATTableAdapter.FillByWorkingTypeId_EngineNo_REV(m_ds.WORKING_DATA_FLOAT, modGlobalVariables.workingtypeID, strEnginNo, intRevNo)
                        ...
                        If CtrlPivotGrid1.Columns(i).Name Like "ID*" _
                            ...
                            Select Case drSettingColumns.DATA_TYPE
                                ...
                                Case DataType.nInteger
                                    ...
                                    Dim dr As DataSet1.WORKING_DATA_FLOATRow
                                    dr = m_ds.WORKING_DATA_FLOAT.FindByENGINE_IDWORKING_COLUMNS_IDREV_NO(intEngineId, intColumnId, intRevNo)
                                    If Not (dr Is Nothing) Then
                                        'dr.ENGINE_ID = intEngineId
                                        'dr.WORKING_COLUMNS_ID = intColumnId
                                        dr.REVISE_DATE = Date.Now
                        ...
                        If CtrlPivotGrid1.Columns(i).Name Like "ID*" _
                            ...
                            Select Case drSettingColumns.DATA_TYPE
                                ...
                                Case DataType.nInteger
                                    ...
                                    'dr = m_ds.WORKING_DATA_INT.NewWORKING_DATA_INTRow
                                    Dim dr As DataSet1.WORKING_DATA_FLOATRow
                                    dr = m_ds.WORKING_DATA_FLOAT.NewWORKING_DATA_FLOATRow
                                    dr.ENGINE_ID = intEngineId
                                    dr.WORKING_COLUMNS_ID = intColumnId
                                    dr.REVISE_DATE = Date.Now
                                    dr.REV_NO = modGlobalVariables.arrIn(2)
                                    dr.DATA = CtrlPivotGrid1.Item(i, 0).Value
                                    'm_ds.WORKING_DATA_INT.AddWORKING_DATA_INTRow(dr)
                                    m_ds.WORKING_DATA_FLOAT.AddWORKING_DATA_FLOATRow(dr)
                                Case DataType.nDateTime
    ...
    Protected Overridable Sub rdoLot_CheckedChanged(sender As Object, e As EventArgs) Handles rdoLot.CheckedChanged

    End Sub

    Protected Overridable Sub rdoUnit_CheckedChanged(sender As Object, e As EventArgs) Handles rdoUnit.CheckedChanged

    End Sub

    Protected Overridable Sub ButtonSELECT_Click(sender As Object, e As EventArgs) Handles ButtonSELECT.Click
