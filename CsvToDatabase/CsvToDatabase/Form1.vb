Public Class Form1
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        Dim datemp As iemt_pdt_es01_developmentDataSetTableAdapters.ENGINE_LISTTableAdapter
        datemp = New iemt_pdt_es01_developmentDataSetTableAdapters.ENGINE_LISTTableAdapter

        Dim dtTemp As New DataTable
        dtTemp = New DataTable("CSV")
            ...
            While Not MyReader.EndOfData
                Try
                    ...
                    If currentRow.Length > 0 Then
                        ...
                        rEngineRow.Item("CREATED_WHEN") = DateTime.Now
                        ...
                        Dim rowResults() As iemt_pdt_es01_developmentDataSet.ENGINE_LISTRow = dtEngineList.Select("ENGINE_NO='" & rEngineRow.Item("ENGINE_NO") & "'")
                        ...
                        Else
                            rEngineRow.Item("UPDATED_WHEN") = rEngineRow.Item("CREATED_WHEN")
                            rEngineRow.Item("CREATED_WHEN") = rowResults(0).Item("CREATED_WHEN")

                            ENGINE_ID = rowResults(0).Item("ID")
                        ...
                        '"category|datatype"
                        'hdaOut(strMode)
                        'hdaOut("11")=New iemt_pdt_es01_developmentDataSetTableAdapters.WORKING_DATA_STRTableAdapter)
                        ...
                        For csspos As Integer = LBound(currentRow) + startColumnPos - 1 To UBound(currentRow)
                            ...
                            If rowsFromSQL.Length > 0 Then
                                ...
                                If category = 1 And datatype = 1 Then
                                    ...
                                    Try
                                        rowdata11.Item("ENGINE_ID") = ENGINE_ID
                                        rowdata11.Item(columnIdName) = id
                                        rowdata11.Item("REV_NO") = revision
                                        rowdata11.Item("DATA") = strTemp4field
                                ...
                                ElseIf category = 1 And datatype = 2 Then
                                    ...
                                    Try
                                        rowdata12.Item("ENGINE_ID") = ENGINE_ID
                                        rowdata12.Item(columnIdName) = id
                                        rowdata12.Item("REV_NO") = revision
                                        rowdata12.Item("DATA") = strTemp4field
                                ...
                                ElseIf category = 1 And datatype = 3 Then
                                    ...
                                    Try
                                        rowdata13.Item("ENGINE_ID") = ENGINE_ID
                                        rowdata13.Item(columnIdName) = id
                                        rowdata13.Item("REV_NO") = revision
                                        rowdata13.Item("DATA") = strTemp4field
